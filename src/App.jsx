...
authDomain: "https://www.google.com/search?q=smartsmspro-4ee81.firebaseapp.com",
...
<h4 className="text-sm sm:text-base font-black uppercase italic tracking-widest text-white/70 group-hover:text-[#25F4EE] transition-colors leading-tight w-full">
{String(q)}
</h4>
{open ? <ChevronUp size={20} className="text-[#25F4EE] shrink-0" /> : <ChevronDown size={20} className="text-white/30 shrink-0" />}
</div>
{open && <p className="mt-5 text-sm text-white/50 leading-relaxed font-medium animate-in slide-in-from-top-2 text-left italic tracking-wide uppercase text-pretty">{String(a)}</p>}
</div>
);
}
...
<p className="text-sm text-white/50 uppercase tracking-widest leading-relaxed mb-10 text-center px-4 max-w-[90%] mx-auto text-balance">
...
<button onClick={handleProtocolHandshake} disabled={loading} className="btn-strategic !bg-[#25F4EE] !text-black text-xs sm:text-sm uppercase py-6 w-full shadow-[0_0_20px_#25F4EE] mt-4">CONFIRM & ACCESS <ChevronRight size={18}/></button>
</div>
