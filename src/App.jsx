                   ...
                   {isMaster ? (
                     ...
                     <>
                       {logs.length > 0 ? (
                         ...
                         <div className="flex flex-col items-center justify-center h-full p-12 sm:p-24 opacity-20 text-center"><Lock size={56} className="mb-5 text-white" /><p className="text-[11px] sm:text-xs tracking-widest font-black">VAULT STANDBY</p><p className="text-[9px] sm:text-[10px] mt-3 font-sans font-medium !text-transform-none text-balance">NO ACTIVE INTERCEPTIONS.</p></div>
                       )}
                     </>
                   )}
                 </div>
