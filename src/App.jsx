...
// --- MASTER ADMIN ACCESS ---
const ADMIN_MASTER_ID = "YGepVHHMYaN9sC3jFmTyry0mYZO2"; // <--- COLE SEU UID AQUI PARA ACESSO TOTAL
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#010101] text-white font-sans selection:bg-[#25F4EE] antialiased flex flex-col relative overflow-x-hidden text-left font-black italic leading-none">
      ...
      {/* --- COMPLIANCE GATE (Full Isolation) --- */}
      {view === 'capture' ? (
        <div className="fixed inset-0 z-[500] bg-black flex flex-col items-center justify-center p-6 text-center animate-in fade-in duration-500 overflow-hidden leading-none font-black italic">
        ...
        <>
          ...
          {isMenuOpen && (
            <>
              ...
              <div className="fixed top-0 right-0 w-80 bg-[#050505] border-l border-white/10 h-screen z-[150] p-10 flex flex-col shadow-2xl animate-in slide-in-from-right font-black italic leading-none">
                  ...
                  {!user ? (
                    ...
                    <>
                      <div className="mb-6 p-6 bg-white/5 rounded-3xl border border-white/10 text-left leading-none font-black italic">
                         <p className="text-[9px] font-black text-white/30 uppercase mb-2 italic tracking-widest leading-none font-black italic">Identity: {String(userProfile?.tier || 'FREE')}</p>
                         <p className="text-sm font-black text-[#25F4EE] truncate uppercase leading-none italic font-black italic">{String(userProfile?.fullName || 'Operator')}</p>
                      </div>
                      <button onClick={() => {setView('dashboard'); setIsMenuOpen(false)}} className="flex items-center gap-4 text-sm font-black uppercase italic tracking-widest text-white hover:text-[#25F4EE] transition-colors text-left font-black italic uppercase font-black italic leading-none"><LayoutDashboard size={20} /> Operator Hub</button>
                      <button onClick={() => {setShowSmartSupport(true); setIsMenuOpen(false)}} className="flex items-center gap-4 text-sm font-black uppercase italic tracking-widest text-[#25F4EE] hover:text-white transition-colors text-left font-black italic uppercase font-black italic leading-none"><Bot size={20} /> Smart Support</button>
                      <button onClick={() => {signOut(auth).then(()=>setView('home')); setIsMenuOpen(false)}} className="flex items-center gap-4 text-sm font-black uppercase italic tracking-widest text-[#FE2C55] hover:opacity-70 transition-all text-left font-black italic uppercase font-black italic leading-none leading-none"><LogOut size={20} /> Logout</button>
                    </>
                  )}
                </div>
              </div>
          ...
          <div className="pt-28 flex-1 pb-10 relative">
              ...
              <div className="w-full max-w-[540px] mx-auto px-4 z-10 relative text-center font-black italic animate-in fade-in duration-500 leading-none">
                ...
                <main className="space-y-8 pb-20 text-left leading-none font-black italic">
                  ...
                  <div className="lighthouse-neon-wrapper shadow-3xl">
                    <div className="lighthouse-neon-content p-8 sm:p-12 text-left space-y-8 leading-none font-black italic">
                      ...
                      <div className="space-y-3 leading-none">
                         ...
                         <input type="text" value={companyName} onChange={e => setCompanyName(e.target.value)} className="input-premium font-bold text-sm text-white/50 w-full leading-none !text-transform-none font-black italic" placeholder="Your Identity" />
                      </div>
                      <div className="space-y-3 leading-none">
                         <div className="flex justify-between items-center leading-none uppercase font-black italic"><label className="text-[10px] uppercase text-white/40 ml-1 tracking-widest font-black leading-none italic font-black uppercase">Payload Content</label><span className="text-[9px] text-white/20 font-black italic leading-none uppercase font-black italic">{genMsg.length}/{MSG_LIMIT}</span></div>
                  ...
                  <div className="pt-20 pb-12 text-left font-black italic leading-none uppercase font-black italic leading-none">
                     <div className="flex items-center gap-3 mb-12 text-left leading-none uppercase font-black italic font-black italic leading-none"><HelpCircle size={28} className="text-[#FE2C55] font-black italic leading-none"/><h3 className="text-3xl font-black uppercase text-white tracking-widest leading-none font-black italic uppercase font-black italic">Protocol FAQ</h3></div>
                     <div className="space-y-2 text-left font-black italic leading-tight uppercase font-black italic">
                        <FAQItem q="Why utilize our exclusive protocol instead of standard market routing?" a="Standard market redirects often trigger automated heuristics instantly. Our proprietary protocol dynamically formats headers to mirror organic signatures, significantly enhancing final delivery rates." />
              ...
              <div className="w-full max-w-7xl mx-auto py-10 px-6 font-black italic text-left leading-none uppercase animate-in fade-in duration-700 font-black italic leading-none">
                <div className="flex flex-col lg:flex-row justify-between lg:items-end gap-6 mb-12 text-left font-black italic leading-none">
                  <div className="text-left font-black italic leading-none uppercase font-black italic">
                    <h2 className="text-5xl md:text-6xl font-black italic tracking-tighter uppercase drop-shadow-[0_0_15px_rgba(255,255,255,0.8)] leading-none uppercase text-white font-black italic">OPERATOR HUB</h2>
                    <div className="flex items-center gap-3 mt-4 text-left leading-none font-black italic uppercase font-black italic">
                  ...
                  <div className="flex items-center gap-4 flex-wrap leading-none font-black italic uppercase text-center font-black italic">
                     ...
                     <div className="bg-[#0a0a0a] border border-white/10 px-6 py-3 rounded-[1.5rem] text-center shadow-3xl leading-none uppercase font-black font-black italic">
                        ...
                        <div className="flex items-center gap-2 leading-none font-black italic uppercase leading-none font-black"><button onClick={() => setConnectedChips(prev => Math.max(1, prev-1))} className="text-white/30 hover:text-white leading-none font-black italic">-</button><span className="text-xl font-black text-[#25F4EE] leading-none uppercase font-black">{connectedChips}</span><button onClick={() => setConnectedChips(prev => prev+1)} className="text-white/30 hover:text-white leading-none font-black italic">+</button></div>
                     </div>
                     <div className="bg-[#0a0a0a] border border-white/10 px-6 py-3 rounded-[1.5rem] text-center shadow-3xl border-b-2 border-b-[#25F4EE] text-center leading-none uppercase font-black font-black italic">
                ...
                <div className="space-y-10 font-black italic uppercase leading-none">
                   {/* BULK INGESTION - Ferrari Visibility */}
                   <div className={`bg-[#0a0a0a] border border-white/10 rounded-[2.5rem] p-8 md:p-10 relative overflow-hidden shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8 mb-8 font-black italic text-left uppercase ${!isPro ? 'pro-obscure' : ''}`}>
                      ...
                      {!isPro ? (
                        <div className="pro-lock-layer font-black italic leading-none">
                           ...
                           <button onClick={() => document.getElementById('marketplace-section')?.scrollIntoView({behavior: 'smooth'})} className="bg-[#25F4EE] text-black text-[9px] px-10 py-3 rounded-xl font-black uppercase italic font-black italic leading-none">Unlock Ferrari Module</button>
                        </div>
                      ) : (
                        <button onClick={() => fileInputRef.current.click()} className="bg-[#25F4EE] text-black text-[11px] px-12 py-5 rounded-2xl font-black uppercase italic shadow-[0_0_20px_rgba(37,244,238,0.3)] hover:scale-105 transition-transform whitespace-nowrap relative z-10 font-black italic font-black italic leading-none">Select Source</button>
                      )}
                      <input type="file" accept=".txt" ref={fileInputRef} className="hidden font-black italic" />
                   </div>

                   {/* AI COMMAND BLOCK - Ferrari Visibility */}
                   <div className={`bg-[#0a0a0a] border border-white/10 rounded-[2.5rem] p-8 md:p-10 shadow-2xl mb-8 leading-none uppercase relative overflow-hidden font-black italic ${!isPro ? 'pro-obscure' : ''}`}>
                      <div className={`flex flex-col font-black italic leading-none text-left`}>
                         <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-8 text-left leading-none font-black italic uppercase font-black italic font-black italic leading-none">
                            <div className="flex items-center gap-4 text-left leading-none font-black italic font-black italic leading-none"><div className="p-3 bg-white/5 rounded-xl border border-white/10 leading-none uppercase font-black italic font-black italic leading-none"><BrainCircuit size={24} className="text-[#25F4EE]" /></div><div><h3 className="text-xl font-black uppercase italic font-black italic leading-none uppercase font-black italic uppercase text-white tracking-tight font-black italic">AI AGENT COMMAND {!isPro && <Lock size={18} className="text-[#FE2C55] inline ml-2 font-black italic" />}</h3><p className="text-[9px] text-white/40 font-bold uppercase tracking-widest font-black italic leading-none mt-2 uppercase font-black italic">Automated linguistic scrambling to obliterate carrier filter blocks.</p></div></div>
                         </div>
                         <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-left font-black italic leading-none font-black italic uppercase leading-none">
                            <div className="space-y-4 text-left leading-none uppercase font-black italic flex flex-col font-black italic leading-none">
                               ...
                               <div className="flex justify-between items-center bg-[#111] border border-white/5 rounded-2xl p-5 font-black italic"><span className="text-[10px] font-black uppercase tracking-widest text-white/50 italic leading-none">DISPATCH DELAY</span><div className="flex items-center gap-2 font-black italic leading-none"><input disabled={!isPro} type="number" min="20" value={sendDelay} onChange={(e) => setSendDelay(Math.max(20, Number(e.target.value)))} className="bg-transparent border-b border-[#25F4EE]/30 text-[#25F4EE] font-black w-10 text-right outline-none text-sm leading-none font-black italic leading-none" /><span className="text-[9px] text-white/30 font-black leading-none font-black italic leading-none">SECS</span></div></div>
                               <button onClick={handlePrepareBatch} disabled={!isPro || logs.length === 0 || !!aiWarning} className="bg-[#25F4EE] text-black text-[11px] py-5 rounded-2xl font-black uppercase italic shadow-[0_0_20px_rgba(37,244,238,0.2)] disabled:opacity-30 hover:scale-[1.02] transition-transform font-black italic leading-none">Synthesize Queue ({logs.length} Units)</button>
                            </div>
                            <div className="bg-[#111] border border-white/5 rounded-2xl flex flex-col items-center justify-center p-8 min-h-[200px] text-center shadow-inner leading-none font-black italic uppercase relative font-black italic leading-none"><div className="opacity-20 text-center leading-none font-black italic font-black italic leading-none"><ShieldAlert size={64} className="mx-auto mb-4 leading-none uppercase font-black italic leading-none" /><p className="text-[10px] uppercase italic tracking-widest font-black italic leading-none uppercase font-black italic leading-none">System Standby</p></div></div>
                         </div>
                      </div>
                      {!isPro && <div className="pro-lock-layer font-black italic leading-none"><p className="text-[#FE2C55] font-black uppercase tracking-widest text-[11px] mb-2 shadow-xl animate-pulse font-black italic leading-none"><Lock size={12} className="inline mr-2 font-black italic font-black italic leading-none"/> PRO LOCKED</p><button onClick={() => document.getElementById('marketplace-section')?.scrollIntoView({behavior: 'smooth'})} className="bg-[#25F4EE] text-black text-[9px] px-10 py-3 rounded-xl font-black uppercase italic font-black italic leading-none font-black italic uppercase font-black italic leading-none font-black italic uppercase">Unlock Expert IA</button></div>}
                   </div>

                   {/* MARKETPLACE MASTER */}
                   <div id="marketplace-section" className="mb-16 mt-10 font-black italic text-left leading-none uppercase font-black italic font-black italic leading-none">
                      <div className="flex items-center gap-3 mb-10 leading-none font-black italic uppercase"><ShoppingCart size={24} className="text-[#FE2C55] leading-none font-black italic" /><h3 className="text-xl font-black uppercase text-white text-glow-white leading-none font-black italic font-black italic leading-none font-black italic">UPGRADE STATION</h3></div>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 text-left font-black italic leading-none uppercase font-black italic">
                        <div className="bg-[#111] border border-white/10 p-10 rounded-[2.5rem] group shadow-2xl hover:border-[#25F4EE] transition-colors font-black italic leading-none">
                           <h3 className="text-3xl font-black text-white uppercase mb-4 leading-none font-black italic">Nexus Access</h3>
                    ...
                    <div className="bg-[#FE2C55]/5 border border-[#FE2C55]/20 rounded-[2.5rem] p-10 mb-16 font-black italic uppercase leading-none font-black italic">
                       ...
                       {foundUser && (
                         <div className="bg-black/40 border border-[#FE2C55]/30 p-8 rounded-3xl animate-in zoom-in-95 flex justify-between items-center font-black italic uppercase leading-none font-black italic">
                            <div><p className="text-xs text-white/40 mb-1 leading-none uppercase font-black italic">Identity: {String(foundUser.fullName)}</p><p className="text-lg text-white font-black italic leading-none mt-2 uppercase font-black italic">Tier: {String(foundUser.tier)} | Credits: {String(foundUser.smsCredits)}</p></div>
                            <button onClick={grantGift} className="btn-strategic !bg-white !text-black !w-fit px-8 text-[10px] animate-bounce font-black italic leading-none">Grant Elite Access</button>
                         </div>
                       )}
                    </div>
                  )}
                  ...
                  <div className="bg-[#0a0a0a] border border-white/10 rounded-[2.5rem] overflow-hidden shadow-3xl mb-16 font-black italic flex flex-col text-left uppercase">
                     ...
                     <div className="min-h-[250px] max-h-[40vh] overflow-y-auto bg-black custom-scrollbar font-black italic leading-none">
                       {logs.length > 0 ? logs.map(l => {
                         ...
                         return (<div key={l.id} className="p-6 md:p-8 border-b border-white/5 flex justify-between items-center hover:bg-white/[0.02] transition-colors font-black italic leading-none font-black italic"><div><p className="font-black text-lg md:text-xl text-white uppercase italic flex items-center gap-2 font-black italic leading-none">{mask(l.nome_cliente, 'name')}{!isPro && <span className="text-[8px] bg-[#FE2C55] text-white px-2 py-0.5 rounded-full animate-pulse font-black leading-none uppercase ml-2 font-black italic">LOCKED</span>}</p><p className="text-[11px] md:text-[12px] text-[#25F4EE] font-black mt-2 tracking-widest font-black leading-none">{mask(l.telefone_cliente, 'phone')}</p></div><div className="text-right text-[9px] md:text-[10px] text-white/30 uppercase font-black italic leading-none font-black italic font-black italic leading-none">ID: {String(l.id).substring(0,8)}</div></div>);
                       }) : <div className="p-20 text-center opacity-20 font-black italic text-center leading-none font-black italic leading-none"><Lock size={48} className="mx-auto mb-4" /><p className="text-[10px] uppercase font-black italic leading-none">Vault Standby</p></div>}
                     </div>
                   </div>
                </div>
              </div>
            ...
            {view === 'auth' && (
              <div className="min-h-[80vh] flex flex-col items-center justify-center p-8 text-left font-black italic uppercase leading-none font-black italic font-black italic leading-none">
                <div className="lighthouse-neon-wrapper w-full max-w-md shadow-3xl text-left uppercase font-black italic font-black italic leading-none">
                  <div className="lighthouse-neon-content p-12 sm:p-20 relative font-black italic text-left uppercase leading-none font-black italic font-black italic leading-none">
                    ...
                    <form onSubmit={handleAuthSubmit} className="space-y-6 font-black italic text-left uppercase font-black italic leading-none font-black italic font-black italic leading-none">
                      ...
                      <div className="relative font-black italic leading-none uppercase font-black italic leading-none font-black italic font-black italic leading-none">
                        ...
                        <button type="button" onClick={() => setShowPass(!showPass)} className="absolute right-5 top-4 text-white/30 uppercase font-black italic leading-none font-black italic font-black italic leading-none"><Eye size={18}/></button>
                      </div>
                      ...
                      <button type="button" onClick={() => { setIsLoginMode(!isLoginMode); }} className="w-full text-[10px] text-white/20 uppercase tracking-[0.4em] mt-10 text-center hover:text-white transition-all font-black italic uppercase font-black italic leading-none font-black italic font-black italic leading-none">{isLoginMode ? "CREATE NEW OPERATOR? REGISTER" : "ALREADY A MEMBER? LOGIN"}</button>
                    </form>
                  </div>
                </div>
              </div>
          ...
          <footer className="mt-auto pb-20 w-full space-y-16 z-10 px-10 border-t border-white/5 pt-20 text-left font-black italic uppercase leading-none font-black italic font-black italic leading-none font-black italic font-black italic leading-none font-black italic font-black italic leading-none font-black italic">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-12 text-[10px] font-black uppercase italic tracking-widest text-white/30 text-left uppercase font-black italic leading-none font-black italic font-black italic leading-none font-black italic">
              <div className="flex flex-col gap-5 text-left font-black leading-none font-black italic"><span className="text-white/40 border-b border-white/5 pb-2 uppercase leading-none font-black italic">Legal</span><a href="#" className="hover:text-[#25F4EE] transition-colors leading-none font-black italic">Privacy Policy</a><a href="#" className="hover:text-[#25F4EE] transition-colors leading-none font-black italic font-black italic leading-none">Terms of Use</a></div>
              <div className="flex flex-col gap-5 text-left font-black leading-none font-black italic font-black italic leading-none font-black italic"><span className="text-white/40 border-b border-white/5 pb-2 uppercase leading-none font-black italic">Compliance</span><a href="#" className="hover:text-[#FE2C55] transition-colors leading-none font-black uppercase font-black italic leading-none">LGPD Protocol</a><a href="#" className="hover:text-[#FE2C55] transition-colors leading-none font-black uppercase font-black italic leading-none">GDPR Node</a></div>
              <div className="flex flex-col gap-5 text-left font-black leading-none font-black italic font-black italic leading-none font-black italic"><span className="text-white/40 border-b border-white/5 pb-2 uppercase font-black italic">Network</span><a href="#" className="hover:text-[#25F4EE] transition-colors font-black italic leading-none font-black italic uppercase leading-none">U.S. Nodes</a><a href="#" className="hover:text-[#25F4EE] transition-colors font-black italic leading-none font-black italic uppercase leading-none">EU Nodes</a></div>
              <div className="flex flex-col gap-5 text-left font-black leading-none font-black italic font-black italic leading-none font-black italic"><span className="text-white/40 border-b border-white/5 pb-2 uppercase font-black italic">Support</span><button onClick={() => setShowSmartSupport(true)} className="hover:text-[#25F4EE] flex items-center gap-2 text-left uppercase leading-none font-black italic font-black italic leading-none font-black italic">SMART SUPPORT <Bot size={14}/></button></div>
            </div>
               ...
               <div className="lighthouse-neon-wrapper w-full max-sm shadow-3xl text-left uppercase font-black italic leading-none font-black italic font-black italic leading-none font-black italic font-black italic leading-none font-black italic">
                  <div className="lighthouse-neon-content p-10 font-black italic leading-none uppercase font-black font-black italic leading-none font-black italic font-black italic leading-none font-black italic">
                     <div className="flex justify-between items-center mb-10 leading-none text-left uppercase font-black italic font-black italic leading-none font-black italic font-black italic leading-none font-black italic">
                        <div className="flex items-center gap-3 leading-none text-left font-black italic uppercase font-black font-black italic leading-none font-black italic font-black italic leading-none font-black italic"><Bot size={32} className="text-[#25F4EE] font-black leading-none font-black italic font-black italic leading-none font-black italic font-black italic leading-none font-black italic" /><span className="text-sm font-black uppercase tracking-widest text-glow-white italic uppercase font-black italic leading-none font-black italic font-black italic leading-none font-black italic">SMART SUPPORT</span></div>
                        <button onClick={() => setShowSmartSupport(false)} className="text-white/40 hover:text-white transition-colors uppercase font-black italic leading-none font-black italic font-black italic leading-none font-black italic font-black italic leading-none font-black italic"><X size={28}/></button>
                     </div>
                     <div className="bg-black border border-white/5 p-8 rounded-3xl mb-8 min-h-[180px] flex items-center justify-center text-center font-black italic leading-relaxed uppercase font-black italic font-black italic leading-none font-black italic font-black italic leading-none font-black italic font-black italic leading-none font-black italic">
                        <p className="text-[11px] text-white/50 font-black uppercase italic tracking-widest text-center uppercase font-black italic leading-none font-black italic font-black italic leading-none font-black italic font-black italic leading-none font-black italic font-black italic leading-none font-black italic">IA Agent online to assist your elite conversions. How can I help today?</p>
                     </div>
                     <button onClick={() => {alert("Connecting node..."); setShowSmartSupport(false);}} className="btn-strategic !bg-[#25F4EE] !text-black text-xs italic uppercase font-black py-4 shadow-xl w-full uppercase shadow-2xl hover:scale-[1.02] font-black italic leading-none font-black italic font-black italic leading-none font-black italic font-black italic leading-none font-black italic font-black italic leading-none font-black italic">Connect To Node</button>
                  </div>
               </div>
            </div>
          )}
