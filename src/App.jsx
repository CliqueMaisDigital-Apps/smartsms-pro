  ...
  return (
    <div className="min-h-screen bg-[#010101] text-white font-sans selection:bg-[#25F4EE] antialiased flex flex-col relative overflow-x-hidden text-left font-black italic leading-none">
      <style>{`
        ...
        /* INPUT FIX: Normal case for login precision */
      ...
      <nav className="fixed top-0 left-0 right-0 h-16 bg-black/80 backdrop-blur-xl border-b border-white/5 z-[100] px-6 flex justify-between items-center">
        ...
        {/* Desktop Header Menu (Highlighted & Intuitive) */}
        <div className="hidden md:flex items-center gap-8 text-[10px] font-black uppercase italic tracking-widest leading-none">
           {!user ? (
             <>
               <button onClick={() => setView('auth')} className="hover:text-[#25F4EE] transition-colors">Member Login</button>
             ...
             <>
               ...
               <button onClick={() => signOut(auth).then(()=>setView('home'))} className="text-[#FE2C55] hover:opacity-70 transition-all">Terminate</button>
             </>
           )}
        </div>
            ...
            <div className="lighthouse-neon-wrapper w-full max-w-lg shadow-3xl">
              <div className="lighthouse-neon-content p-12 sm:p-20 flex flex-col items-center">
                ...
                <div className="w-full space-y-5 text-left">
                  ...
                  <input required type="tel" placeholder="Mobile Number Identity" value={captureForm.phone} onChange={e=>setCaptureForm({...captureForm, phone: e.target.value})} className="input-premium text-sm w-full font-medium italic !bg-black/50" />
            ...
            <main className="space-y-8 pb-20 text-left font-black italic leading-none">
              ...
              <div className="lighthouse-neon-wrapper shadow-3xl">
                <div className="lighthouse-neon-content p-8 sm:p-12 text-left space-y-8 leading-none">
                  ...
                  <div className="space-y-3 leading-none">
                     <label className="text-[10px] uppercase text-white/40 ml-1 tracking-widest font-black block leading-none italic font-black uppercase">Global Number <span className="text-[#25F4EE] ml-2 opacity-50 uppercase tracking-widest text-[8px]">ex: +1 999 999 9999</span></label>
              ...
              <div className="pt-20 pb-12 text-left font-black italic leading-none uppercase">
                 ...
                 <div className="space-y-2 text-left font-black italic leading-tight uppercase">
                    <FAQItem q="Why utilize our exclusive protocol instead of standard redirects?" a="Standard market redirects often trigger carrier heuristics instantly. Our proprietary protocol dynamically formats headers to mirror organic traffic signatures globally, significantly enhancing final delivery rates while adhering to global communication acts." />
                    <FAQItem q="Is the cryptographic vault fully impenetrable and compliant?" a="Absolutely. Operating under a Zero-Knowledge architecture, your data remains encrypted within your session context. We maintain rigorous alignment with international protection protocols (GDPR/LGPD), ensuring enterprise-grade privacy." />
                    ...
                    <FAQItem q="What is the strategic advantage of Advanced AI Synthesis?" a="The AI Agent dynamically optimizes payload contexts in real-time. By utilizing advanced linguistic frameworks, it ensures each dispatch maintains a unique organic fingerprint, maximizing user engagement and campaign conversions." />
                 </div>
              </div>
            </main>
          </div>
          ...
          <div className="w-full max-w-7xl mx-auto py-10 px-6 font-black italic text-left leading-none uppercase animate-in fade-in duration-700">
            <div className="flex flex-col lg:flex-row justify-between lg:items-end gap-6 mb-12 text-left font-black italic leading-none">
              ...
              <div className="flex items-center gap-4 flex-wrap leading-none font-black italic uppercase text-center">
                 <button onClick={() => setView('home')} className="flex items-center gap-2 bg-white/5 border border-white/10 px-6 py-3.5 rounded-xl hover:bg-white/10 transition-colors text-[9px] font-black italic uppercase text-white leading-none"><Zap size={14} className="text-[#25F4EE]"/> LINK GENERATOR</button>
            ...
            <div className="space-y-10">
               ...
               <div className="bg-[#0a0a0a] border border-white/10 rounded-[2.5rem] p-8 md:p-10 relative overflow-hidden shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8 mb-8 font-black italic leading-none text-left uppercase">
                  ...
                  {!isPro && <div className="absolute inset-0 bg-black/60 backdrop-blur-[2px] z-20 flex flex-col items-center justify-center p-6"><p className="text-[#FE2C55] font-black uppercase tracking-widest text-[11px] mb-2 shadow-xl"><Lock size={12} className="inline mr-2"/> PRO PROTOCOL LOCKED</p><p className="text-white/60 text-[9px] uppercase tracking-widest text-center max-w-lg leading-relaxed uppercase">ATTENTION: TOP TIER ORGANIZATIONS INTEGRATE THIS TO SCALE AUTOMATED OPERATIONS. YOU ARE LEAVING MONEY ON THE TABLE.</p></div>}
               </div>

               {/* AI COMMAND & DELAY MOTOR */}
               <div className="bg-[#0a0a0a] border border-white/10 rounded-[2.5rem] p-8 md:p-10 shadow-2xl mb-8 leading-none uppercase relative overflow-hidden">
                  <div className={`flex flex-col font-black italic leading-none uppercase ${!isPro ? 'opacity-30' : ''} leading-none text-left uppercase`}>
                  ...
                  {!isPro && <div className="absolute inset-0 bg-black/60 backdrop-blur-[2px] z-20 flex flex-col items-center justify-center p-6"><p className="text-[#FE2C55] font-black uppercase tracking-widest text-[11px] mb-2 shadow-xl"><Lock size={12} className="inline mr-2"/> PRO PROTOCOL LOCKED</p><p className="text-white/60 text-[9px] uppercase tracking-widest text-center max-w-lg leading-relaxed uppercase">BY NOT UTILIZING THE NATIVE SYNTHESIS ENGINE, YOU BYPASS SAFETY HEURISTICS. SECURE FULL ACCESS TO PROCEED.</p></div>}
               </div>

               {/* MARKETPLACE BLOCK */}
               <div id="marketplace-section" className="mb-16 mt-10 font-black italic text-left leading-none uppercase">
                  <div className="flex items-center gap-3 mb-8 text-left leading-none font-black italic uppercase leading-none uppercase"><ShoppingCart size={24} className="text-[#FE2C55]" /><h3 className="text-xl font-black uppercase text-white font-black italic leading-none uppercase text-glow-white">UPGRADE STATION</h3></div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                    ...
                    <div className="bg-[#25F4EE]/10 border border-[#25F4EE]/30 p-10 rounded-[2.5rem] group shadow-2xl text-left leading-none font-black italic uppercase hover:scale-[1.01] transition-transform">
               ...
               <div className="bg-[#0a0a0a] border border-white/10 rounded-[2.5rem] overflow-hidden shadow-3xl mb-16 font-black italic flex flex-col font-black italic leading-none text-left uppercase">
                 ...
                 {!isPro && logs.length > 0 && (<div className="p-6 md:p-8 bg-[#FE2C55]/5 border-t border-[#FE2C55]/20 flex flex-col items-center justify-center text-center gap-4 mt-auto font-black italic leading-none leading-none font-black italic uppercase leading-none"><p className="text-[10px] md:text-[11px] text-[#FE2C55] uppercase tracking-widest flex items-center justify-center gap-2 font-black italic leading-none leading-none uppercase font-black italic uppercase leading-none uppercase">REVEAL FULL IDENTITIES? UPGRADE TO ELITE ACCESS NOW.</p><button onClick={() => document.getElementById('marketplace-section')?.scrollIntoView({behavior: 'smooth'})} className="btn-strategic !bg-[#FE2C55] !text-white text-[10px] w-full max-w-[300px] py-4 shadow-[0_0_20px_#FE2C55] font-black italic uppercase leading-none font-black italic shadow-xl leading-none font-black italic uppercase leading-none">UNLOCK VAULT NOW</button></div>)}
               </div>
           ...
           <div className="lighthouse-neon-wrapper w-full max-w-sm shadow-3xl text-left font-black italic leading-none uppercase font-black">
              <div className="lighthouse-neon-content p-10 font-black italic leading-none uppercase">
                 ...
                 <div className="bg-black border border-white/5 p-8 rounded-3xl mb-8 min-h-[180px] flex items-center justify-center text-center font-black italic leading-none uppercase font-black leading-relaxed leading-none uppercase font-black">
                    <p className="text-[11px] text-white/50 font-black uppercase italic tracking-widest text-center font-black italic leading-none font-black uppercase leading-none uppercase font-black">IA Agent analyzing operational metadata... online to optimize your protocol and campaign conversions.</p>
                 </div>
